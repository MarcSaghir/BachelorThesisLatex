...
Both ensemble experiments returned usable results, that showed learning behavior by the ensemble classifiers. Using correct thresholding, one is able to achieve passable 
