...
\input{figures/locoallapproaches/locoallapproaches.tex}
...
\input{figures/overshootexamples/overshootandsmallanomalies.tex}
...
As visible in Fig. \ref{fig:pca_res}, the segmentation results appeared to be not more meaningful than gaussian noise, strongly suggesting that this method has failed. Subsection 
...
using threshoolding the results are usable, as often anomalous regions are discernible. Fig. \ref{fig:ensembleFCimages} also showcases examples of failed segmentation 
attempts. 
