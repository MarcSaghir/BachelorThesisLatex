...
\newline
\cite{Guo_2017_tempscalingetc} review multiple promising ways to calibrate the confidence of a model. %Hier noch satz hin mit formeln für bestandteile
...
%noch formeln hinschreiben für logs, possibilities etc?
...
performance that can also be boosted using simple majority voting(checken obs nicht doch averaging war) ensembles in its paper. Yet due to its nature as a representation based approach, patchcores 
