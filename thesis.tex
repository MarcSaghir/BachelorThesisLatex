...
\newcommand{\content}{%
	...
	\input{content/3-relatedwork}%
	\input{content/4-method}%
	\input{content/5-experimentsetup}%
	\input{content/6-results}%
...
\begin{document}
	...
	\Metadata{
		title=Ensemeble Methods for Visual Anomaly Detection in Manufacturing Settings,
		author=Marc Saghir
	}
	
	\title{Ensemeble Methods for Visual Anomaly Detection in Manufacturing Settings}
	\subtitle{Toller Thesis Titel}
	\author[A. Author]{Marc Saghir} %optionales Argument ist die Signatur,
