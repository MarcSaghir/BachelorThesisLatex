...
\newcommand{\content}{%
	\input{IAS-thesis-MSRL/content/1-introduction}%
	\input{IAS-thesis-MSRL/content/2-background}%
	\input{IAS-thesis-MSRL/content/3-relatedwork}%
	\input{IAS-thesis-MSRL/content/4-method}%
	\input{IAS-thesis-MSRL/content/5-experimentsetup}%
	\input{IAS-thesis-MSRL/content/6-results}%
	\input{IAS-thesis-MSRL/content/7-conclusion}%
}
...
\begin{document}
	...
	\Metadata{
		title=Terrific Thesis Title,
		author=Amazing Author
	}
	
	\title{Terrific Thesis Title}
	\subtitle{Toller Thesis Titel}
	\author[A. Author]{Amazing Author} %optionales Argument ist die Signatur,
	\birthplace{Home}%Geburtsort, bei Dissertationen zwingend notwendig
	\reviewer{Super Supervisor}%Gutachter
	...
	%%
	\input{IAS-thesis-MSRL/meta/abstract}
	%%
